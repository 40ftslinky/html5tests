...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[602,400,192,50],[602,0,240,327],[0,0,600,500],[602,329,320,69]]},
...
(lib.image_luxury_300x250 = function() {
...
(lib.text2_luxury_300x250 = function() {
	this.initialize(ss["index_atlas_P_"]);
	this.gotoAndStop(3);
}).prototype = p = new cjs.Sprite();
...
(lib.text2b = function(mode,startPosition,loop) {
	...
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-83.3,-25.9)).s().p("Ar9BWIAAirIX8AAIAACrg")
	}.bind(this);
	this.shape.setTransform(16,184.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60.6,176,153.3,17.19999999999999);
...
(lib.text2a = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-83.3,-8.6)).s().p("Ar+BWIAAirIX8AAIAACrg")
	}.bind(this);
	this.shape.setTransform(16,185);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60.6,176.4,153.3,17.299999999999983);
...
(lib.text2_red = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-3.3,-17.2)).s().p("AghCsIAAlYIBDAAIAAFYg")
	}.bind(this);
	this.shape.setTransform(-240.5,193.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-243.8,176.3,6.700000000000017,34.5);
...
(lib.image_main = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.image_luxury_300x250();
	this.instance.parent = this;
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:71.5,y:194.875}).wait(46));

	// Layer_3
	this.instance = new lib.text2b("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-70.45,27.55,1,1,0,0,0,88.3,10);
	...
	this.instance_1.setTransform(13.55,8.5,1,1,0,0,0,89.3,8.5);
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AleNhIAAmcIBFAAIAAGcg");
	var mask_1_graphics_1 = new cjs.Graphics().p("AleOLIAAmdIBFAAIAAGdg");
	var mask_1_graphics_2 = new cjs.Graphics().p("AleOwIAAmcIBFAAIAAGcg");
	var mask_1_graphics_3 = new cjs.Graphics().p("AlePQIAAmcIBFAAIAAGcg");
	var mask_1_graphics_4 = new cjs.Graphics().p("AlePrIAAmcIBFAAIAAGcg");
	var mask_1_graphics_5 = new cjs.Graphics().p("AleQBIAAmcIBFAAIAAGcg");
	var mask_1_graphics_6 = new cjs.Graphics().p("AleQTIAAmdIBFAAIAAGdg");
	var mask_1_graphics_7 = new cjs.Graphics().p("AleQfIAAmcIBFAAIAAGcg");
	var mask_1_graphics_8 = new cjs.Graphics().p("AleQnIAAmdIBFAAIAAGdg");
	var mask_1_graphics_9 = new cjs.Graphics().p("AleQpIAAmdIBFAAIAAGdg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:-35.075,y:86.5}).wait(1).to({graphics:mask_1_graphics_1,x:-35.075,y:90.6975}).wait(1).to({graphics:mask_1_graphics_2,x:-35.075,y:94.4012}).wait(1).to({graphics:mask_1_graphics_3,x:-35.075,y:97.6111}).wait(1).to({graphics:mask_1_graphics_4,x:-35.075,y:100.3272}).wait(1).to({graphics:mask_1_graphics_5,x:-35.075,y:102.5494}).wait(1).to({graphics:mask_1_graphics_6,x:-35.075,y:104.2778}).wait(1).to({graphics:mask_1_graphics_7,x:-35.075,y:105.5123}).wait(1).to({graphics:mask_1_graphics_8,x:-35.075,y:106.2531}).wait(1).to({graphics:mask_1_graphics_9,x:-35.075,y:106.5}).wait(51));
...
p.nominalBounds = new cjs.Rectangle(-67.8,0,160.5,210.8);
...
(lib.texty1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-37.65,49.5,1,1,0,0,0,119.3,49.5);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-32.95,63.5,1,1,0,0,0,125,63.5);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-34.25,188.55,1,1,0,0,0,123.2,61.5);
...
// stage content:
(lib.RAM_luxury_300x250 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_.png?1568784117611", id:"index_atlas_P_"},
		{src:"images/index_atlas_NP_.jpg?1568784117611", id:"index_atlas_NP_"}
	],
	preloads: []
};
