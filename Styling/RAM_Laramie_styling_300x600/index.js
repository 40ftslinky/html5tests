...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[0,792,278,72],[0,373,240,327],[0,0,480,371],[0,702,493,88]]},
...
(lib.image_styling_300x600 = function() {
...
(lib.text2b = function(mode,startPosition,loop) {
	...
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-119.1,-32)).s().p("AymB4IAAjvMAlNAAAIAADvg")
	}.bind(this);
	this.shape.setTransform(62.275,95.525);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-56.8,83.6,238.2,23.900000000000006);
...
(lib.text2a = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-119.1,-10)).s().p("AymBkIAAjHMAlNAAAIAADHg")
	}.bind(this);
	this.shape.setTransform(62.025,91.525);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-57.1,81.5,238.29999999999998,20.099999999999994);
...
(lib.text2_red = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-242.4,-22)).s().p("AgoDcIAAm3IBRAAIAAG3g")
	}.bind(this);
	this.shape.setTransform(9.025,104);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(4.9,82,8.299999999999999,44);
...
(lib.image_main = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.image_styling_300x600();
	this.instance.parent = this;
...
p.nominalBounds = new cjs.Rectangle(0,0,300,600.5);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask.setTransform(61.55,101.05);

	// Layer_3
	this.instance = new lib.text2b("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(331.55,27.55,1,1,0,0,0,88.3,10);
	...
	this.instance_1.setTransform(224.55,8.5,1,1,0,0,0,89.3,8.5);
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AN2GZIAAmjIBFAAIAAGjg");
	var mask_1_graphics_1 = new cjs.Graphics().p("AN2HFIAAmkIBFAAIAAGkg");
	var mask_1_graphics_2 = new cjs.Graphics().p("AN2HsIAAmkIBFAAIAAGkg");
	var mask_1_graphics_3 = new cjs.Graphics().p("AN2IOIAAmkIBFAAIAAGkg");
	var mask_1_graphics_4 = new cjs.Graphics().p("AN2IrIAAmkIBFAAIAAGkg");
	var mask_1_graphics_5 = new cjs.Graphics().p("AN2JCIAAmkIBFAAIAAGkg");
	var mask_1_graphics_6 = new cjs.Graphics().p("AN2JVIAAmkIBFAAIAAGkg");
	var mask_1_graphics_7 = new cjs.Graphics().p("AN2JiIAAmkIBFAAIAAGkg");
	var mask_1_graphics_8 = new cjs.Graphics().p("AN2JpIAAmkIBFAAIAAGkg");
	var mask_1_graphics_9 = new cjs.Graphics().p("AN2JsIAAmkIBFAAIAAGkg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:95.475,y:40.8751}).wait(1).to({graphics:mask_1_graphics_1,x:95.475,y:45.3088}).wait(1).to({graphics:mask_1_graphics_2,x:95.475,y:49.2208}).wait(1).to({graphics:mask_1_graphics_3,x:95.475,y:52.6112}).wait(1).to({graphics:mask_1_graphics_4,x:95.475,y:55.4801}).wait(1).to({graphics:mask_1_graphics_5,x:95.475,y:57.8273}).wait(1).to({graphics:mask_1_graphics_6,x:95.475,y:59.6529}).wait(1).to({graphics:mask_1_graphics_7,x:95.475,y:60.9569}).wait(1).to({graphics:mask_1_graphics_8,x:95.475,y:61.7393}).wait(1).to({graphics:mask_1_graphics_9,x:95.475,y:62.0001}).wait(51));
...
p.nominalBounds = new cjs.Rectangle(-57.1,0,246.29999999999998,125.1);
...
(lib.texty1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-63.65,49.5,1,1,0,0,0,119.3,49.5);
	this.instance._off = true;
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-59.95,63.5,1,1,0,0,0,125,63.5);
	this.instance_1._off = true;
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-60.25,188.55,1,1,0,0,0,123.2,61.5);
...
// stage content:
(lib.RAM_styling_300x600 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_.png?1568787834676", id:"index_atlas_P_"},
		{src:"images/index_atlas_NP_.jpg?1568787834676", id:"index_atlas_NP_"}
	],
	preloads: []
};
