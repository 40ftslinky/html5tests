...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[419,502,192,50],[602,0,240,327],[0,0,600,500],[0,502,417,69]]},
...
(lib.image_styling_300x250 = function() {
...
(lib.text2b = function(mode,startPosition,loop) {
	...
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-107.1,-25.9)).s().p("Av1BWIAAirIfrAAIAACrg")
	}.bind(this);
	this.shape.setTransform(39.5,5.05);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-61.8,-3.5,202.7,17.2);
...
(lib.text2a = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-107.1,-8.6)).s().p("Av1BXIAAitIfrAAIAACtg")
	}.bind(this);
	this.shape.setTransform(39.5,5.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-61.8,-3.1,202.7,17.3);
...
(lib.text2_red = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-2.9,-17.2)).s().p("AgcCsIAAlXIA5AAIAAFXg")
	}.bind(this);
	this.shape.setTransform(-241,14.05);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-243.9,-3.2,5.800000000000011,34.5);
...
(lib.image_main = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.image_styling_300x250();
	this.instance.parent = this;
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:71.75,y:12.875}).wait(46));

	// Layer_3
	this.instance = new lib.text2b("synched",0);
	this.instance.parent = this;
	this.instance.setTransform(-119.7,27.55,1,1,0,0,0,88.3,10);
	...
	this.instance_1.setTransform(13.8,8.5,1,1,0,0,0,89.3,8.5);
	...
	mask_1._off = true;
	var mask_1_graphics_0 = new cjs.Graphics().p("AldC0IAAmbIBFAAIAAGbg");
	var mask_1_graphics_1 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_2 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_3 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_4 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_5 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_6 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_7 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_8 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");
	var mask_1_graphics_9 = new cjs.Graphics().p("AldDOIAAmbIBFAAIAAGbg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:mask_1_graphics_0,x:-34.975,y:-23.225}).wait(1).to({graphics:mask_1_graphics_1,x:-34.975,y:-17.7448}).wait(1).to({graphics:mask_1_graphics_2,x:-34.975,y:-10.6151}).wait(1).to({graphics:mask_1_graphics_3,x:-34.975,y:-4.4361}).wait(1).to({graphics:mask_1_graphics_4,x:-34.975,y:0.7923}).wait(1).to({graphics:mask_1_graphics_5,x:-34.975,y:5.0701}).wait(1).to({graphics:mask_1_graphics_6,x:-34.975,y:8.3972}).wait(1).to({graphics:mask_1_graphics_7,x:-34.975,y:10.7738}).wait(1).to({graphics:mask_1_graphics_8,x:-34.975,y:12.1997}).wait(1).to({graphics:mask_1_graphics_9,x:-34.975,y:12.675}).wait(51));
...
p.nominalBounds = new cjs.Rectangle(-67.8,-3.2,208.7,34.5);
...
// stage content:
(lib.RAM_styling_300x250 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_.png?1568787462189", id:"index_atlas_P_"},
		{src:"images/index_atlas_NP_.jpg?1568787462189", id:"index_atlas_NP_"}
	],
	preloads: []
};
