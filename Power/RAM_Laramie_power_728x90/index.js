...
// stage content:
(lib.RAM_power_728x90 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_.png?1568864200885", id:"index_atlas_P_"},
		{src:"images/index_atlas_NP_.jpg?1568864200885", id:"index_atlas_NP_"}
	],
	preloads: []
};
