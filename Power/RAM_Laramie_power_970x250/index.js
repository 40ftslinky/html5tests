...
lib.ssMetadata = [
		{name:"index_atlas_P_", frames: [[552,209,252,65],[0,0,1236,207],[1238,0,593,402],[0,209,550,120]]},
...
(lib.image_power_970x250 = function() {
...
(lib.text2b = function(mode,startPosition,loop) {
	...
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-130.6,-41.8)).s().p("A0ZCYIAAkvMAozAAAIAAEvg")
	}.bind(this);
	this.shape.setTransform(694.75,24.275);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(564.1,9.1,261.29999999999995,30.4);
...
(lib.text2a = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-130.6,-13.3)).s().p("A0aCFIAAkJMAo1AAAIAAEJg")
	}.bind(this);
	this.shape.setTransform(694.45,13.575);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(563.8,0.3,261.30000000000007,26.599999999999998);
...
(lib.text2_red = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],3);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-265.9,-28.5)).s().p("AgtEdIAAo5IBbAAIAAI5g")
	}.bind(this);
	this.shape.setTransform(653.6,28.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(649,0,9.200000000000045,57);
...
(lib.text1b = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],2);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-151.9,-87.5)).s().p("A2lCgIAAk/MAtLAAAIAAE/g")
	}.bind(this);
	this.shape.setTransform(414.5,112);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(269.9,96,289.20000000000005,32);
...
(lib.text1a = function(mode,startPosition,loop) {
	...
	var sprImg_shape = cjs.SpriteSheetUtils.extractFrame(ss["index_atlas_P_"],2);
	sprImg_shape.onload = function(){
		this.shape.graphics.bf(sprImg_shape, null, new cjs.Matrix2D(0.5,0,0,0.5,-151.9,-35.8)).s().p("A2lFmIAArLMAtLAAAIAALLg")
	}.bind(this);
	this.shape.setTransform(412.5,60.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(267.9,24.3,289.20000000000005,71.5);
...
(lib.image_main = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.image_power_970x250();
	this.instance.parent = this;
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	mask.setTransform(678.925,29.65);
...
p.nominalBounds = new cjs.Rectangle(563.8,0,270.5,57);
...
(lib.texty1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(14).to({graphics:mask_graphics_14,x:516.5,y:123.6}).wait(76));
...
p.nominalBounds = new cjs.Rectangle(0,0,609.2,225.8);


// stage content:
(lib.RAM_power_970x250 = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_P_.png?1568793680339", id:"index_atlas_P_"},
		{src:"images/index_atlas_NP_.jpg?1568793680339", id:"index_atlas_NP_"}
	],
	preloads: []
};
